...
window.PRODUCTS_DATA = [
  // ===== VD601 无线图传模块 =====
  {
    ...
    icon: '<img loading="lazy" decoding="async" src="assets/products/vd601.webp" style="width:100%;height:100%;object-fit:contain;" alt="VD601">',
    gallery: [
      "assets/products/vd601-view1.webp",
      "assets/products/vd601-view2.webp",
      "assets/products/vd601-view3.webp",
      "assets/products/vd601-view4.webp"
    ],
    features: [
    ...
    highlights: [
      { icon: "assets/products/vd601-icon1.webp", label: { zh: "最远传输距离", en: "Max Range" }, value: { zh: "150Km", en: "150Km" } },
      { icon: "assets/products/vd601-icon2.webp", label: { zh: "中继", en: "Relay" }, value: { zh: "16跳", en: "16 Hops" } },
      { icon: "assets/products/vd601-icon3.webp", label: { zh: "最大传输速率", en: "Max Throughput" }, value: { zh: "100Mbps", en: "100Mbps" } },
      { icon: "assets/products/vd601-icon4.webp", label: { zh: "星型组网", en: "Star Network" }, value: { zh: "1+64", en: "1+64" } },
      { icon: "assets/products/vd601-icon5.webp", label: { zh: "MESH组网", en: "MESH Network" }, value: { zh: "64节点", en: "64 Nodes" } },
      { icon: "assets/products/vd601-icon6.webp", label: { zh: "高灵敏度", en: "High Sensitivity" }, value: { zh: "自适应", en: "Adaptive" } }
    ],
  ...
  // ===== VA10 高清图传发射模块 =====
  {
    ...
    tagline: { zh: "", en: "" },
    price: { zh: "面议", en: "Contact for price" },
    icon: '<img loading="lazy" decoding="async" src="assets/products/va10.webp" style="width:100%;height:100%;object-fit:contain;" alt="VA10">',
    gallery: [
      "assets/products/va10-view1.webp",
      "assets/products/va10-view2.webp",
      "assets/products/va10-view3.webp",
      "assets/products/va10-view4.webp"
    ],
    features: [
    ...
    highlights: [
      { icon: "assets/products/va10-icon2.webp", label: { zh: "4.8-7.2GHz", en: "4.8-7.2GHz" }, value: { zh: "宽频段", en: "Wide Band" } },
      { icon: "assets/products/va10-icon1.webp", label: { zh: "4W高功率", en: "4W High Power" }, value: { zh: "可调", en: "Adjustable" } },
      { icon: "assets/products/va10-icon4.webp", label: { zh: "184CH信道", en: "184CH Channels" }, value: { zh: "可选", en: "Selectable" } },
      { icon: "assets/products/va10-icon5.webp", label: { zh: "稳定传输", en: "Stable Transmission" }, value: { zh: "抗干扰强", en: "Anti-Interference" } },
      { icon: "assets/products/va10-icon6.webp", label: { zh: "全金属外壳", en: "All-Metal Shell" }, value: { zh: "高效散热", en: "Efficient Cooling" } },
      { icon: "assets/products/va10-icon7.webp", label: { zh: "轻巧便携", en: "Lightweight" }, value: { zh: "安装简便", en: "Easy Install" } }
    ],
  ...
  // ===== ZS1000 惯性导航传感器 =====
  {
    ...
    price: { zh: "面议", en: "Contact for price" },
    icon: '<img loading="lazy" decoding="async" src="assets/products/zs1000.webp" style="width:100%;height:100%;object-fit:contain;" alt="ZS1000">',
    gallery: [
      "assets/products/zs1000.webp",
      "assets/products/zs1000-view1.webp",
      "assets/products/zs1000-view2.webp"
    ],
    features: [
  ...
  // ===== D+ 远距离数传模块 =====
  {
    ...
    price: { zh: "面议", en: "Contact for price" },
    icon: '<img loading="lazy" decoding="async" src="assets/products/d_plus.webp" style="width:100%;height:100%;object-fit:contain;" alt="D+">',
    gallery: [
      "assets/products/d_plus.webp",
      "assets/products/d_plus-view1.webp"
    ],
    features: [
    ...
    highlights: [
      { icon: "assets/products/highlight_range.webp", label: { zh: "最远传输距离", en: "Max Range" }, value: { zh: "300km", en: "300km" } },
      { icon: "assets/products/highlight_relay.webp", label: { zh: "中继", en: "Relay" }, value: { zh: "支持16跳", en: "16 Hops" } },
      { icon: "assets/products/highlight_star.webp", label: { zh: "星型组网", en: "Star Network" }, value: { zh: "最多1024个", en: "Up to 1024" } },
      { icon: "assets/products/highlight_mesh.webp", label: { zh: "MESH组网", en: "MESH Network" }, value: { zh: "最多1024个", en: "Up to 1024" } }
    ],
  ...
  // ===== VD602 无线图传模块 =====
  {
    ...
    price: { zh: "面议", en: "Contact for price" },
    icon: '<img loading="lazy" decoding="async" src="assets/products/vd602.webp" style="width:100%;height:100%;object-fit:contain;" alt="VD602">',
    gallery: [
      "assets/products/vd602.webp",
      "assets/products/vd602-view2.webp",
      "assets/products/vd602-view4.webp",
      "assets/products/vd602-view5.webp"
    ],
    features: [
    ...
    highlights: [
      { icon: "assets/products/highlight_speed.webp", label: { zh: "最大传输速率", en: "Max Throughput" }, value: { zh: "100Mbps", en: "100Mbps" } },
      { icon: "assets/products/highlight_sensitivity.webp", label: { zh: "高灵敏度", en: "High Sensitivity" }, value: { zh: "自适应", en: "Adaptive" } },
      { icon: "assets/products/highlight_range.webp", label: { zh: "最远传输距离", en: "Max Range" }, value: { zh: "15Km", en: "15Km" } },
      { icon: "assets/products/highlight_relay.webp", label: { zh: "中继", en: "Relay" }, value: { zh: "16跳", en: "16 Hops" } },
      { icon: "assets/products/highlight_star.webp", label: { zh: "星型组网", en: "Star Network" }, value: { zh: "1+64", en: "1+64" } },
      { icon: "assets/products/highlight_mesh.webp", label: { zh: "MESH组网", en: "MESH Network" }, value: { zh: "64节点", en: "64 Nodes" } }
    ],
  ...
  // ===== VA20 高清图传发射模块 =====
  {
    ...
    highlights: [
      { icon: "assets/products/va10-icon2.webp", label: { zh: "宽频段", en: "Wide Band" }, value: { zh: "1.2GHz", en: "1.2GHz" } },
      { icon: "assets/products/va10-icon1.webp", label: { zh: "高功率", en: "High Power" }, value: { zh: "4W可调", en: "4W Adjustable" } },
      { icon: "assets/products/va10-icon4.webp", label: { zh: "信道", en: "Channels" }, value: { zh: "8CH", en: "8CH" } },
      { icon: "assets/products/va10-icon5.webp", label: { zh: "抗干扰", en: "Anti-Interference" }, value: { zh: "稳定传输", en: "Stable" } },
      { icon: "assets/products/va10-icon6.webp", label: { zh: "散热", en: "Cooling" }, value: { zh: "全金属外壳", en: "All-Metal" } },
      { icon: "assets/products/va10-icon7.webp", label: { zh: "便携", en: "Portable" }, value: { zh: "轻巧安装", en: "Lightweight" } }
    ],
  ...
  // ===== D 数传模块 =====
  {
    ...
    price: { zh: "面议", en: "Contact for price" },
    icon: '<img loading="lazy" decoding="async" src="assets/products/d.webp" style="width:100%;height:100%;object-fit:contain;" alt="D">',
    gallery: [
      "assets/products/d.webp",
      "assets/products/d-view1.webp"
    ],
    features: [
      { zh: "自适应跳频，每秒大于1800次", en: "Adaptive frequency hopping >1800 hops/s" },
    ...
    highlights: [
      { icon: "assets/products/highlight_range.webp", label: { zh: "最远传输距离", en: "Max Range" }, value: { zh: "30Km", en: "30Km" } },
      { icon: "assets/products/highlight_relay.webp", label: { zh: "中继", en: "Relay" }, value: { zh: "支持16跳", en: "16 Hops" } },
      { icon: "assets/products/highlight_star.webp", label: { zh: "星型组网", en: "Star Network" }, value: { zh: "最多1024个", en: "Up to 1024" } },
      { icon: "assets/products/highlight_mesh.webp", label: { zh: "MESH组网", en: "MESH Network" }, value: { zh: "最多1024个", en: "Up to 1024" } }
    ],
  ...
  // ===== VM+ 图数一体模块 =====
  {
    ...
    price: { zh: "面议", en: "Contact for price" },
    icon: '<img loading="lazy" decoding="async" src="assets/products/vm_plus.webp" style="width:100%;height:100%;object-fit:contain;" alt="VM+">',
    gallery: [],
    features: [
    ...
    highlights: [
      { icon: "assets/products/highlight_range.webp", label: { zh: "最远传输距离", en: "Max Range" }, value: { zh: "500km", en: "500km" } },
      { icon: "assets/products/highlight_relay.webp", label: { zh: "中继", en: "Relay" }, value: { zh: "支持16跳", en: "16 Hops" } },
      { icon: "assets/products/highlight_star.webp", label: { zh: "星型组网", en: "Star Network" }, value: { zh: "支持64个", en: "Up to 64" } },
      { icon: "assets/products/highlight_mesh.webp", label: { zh: "MESH组网", en: "MESH Network" }, value: { zh: "支持64个", en: "Up to 64" } }
    ],
  ...
  // ===== V3 图数一体模块 =====
  {
    ...
    price: { zh: "面议", en: "Contact for price" },
    icon: '<img loading="lazy" decoding="async" src="assets/products/v3.webp" style="width:100%;height:100%;object-fit:contain;" alt="V3">',
    gallery: [],
    features: [
    ...
    highlights: [
      { icon: "assets/products/highlight_range.webp", label: { zh: "最远传输距离", en: "Max Range" }, value: { zh: "150km", en: "150km" } },
      { icon: "assets/products/highlight_relay.webp", label: { zh: "中继", en: "Relay" }, value: { zh: "支持16跳", en: "16 Hops" } },
      { icon: "assets/products/highlight_star.webp", label: { zh: "星型组网", en: "Star Network" }, value: { zh: "支持1+64个", en: "Up to 1+64" } },
      { icon: "assets/products/highlight_mesh.webp", label: { zh: "MESH组网", en: "MESH Network" }, value: { zh: "支持64个", en: "Up to 64" } }
    ],
